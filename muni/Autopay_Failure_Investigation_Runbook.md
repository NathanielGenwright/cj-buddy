...
## Table of Contents
1. [Overview](#overview)
2. [Incident Response Priority](#incident-response-priority)
3. [Investigation Checklist](#investigation-checklist)
   - [Phase 1: Initial Triage](#phase-1-initial-triage-5-minutes)
   - [Phase 2: System-Wide Failure Investigation](#phase-2-system-wide-failure-investigation)
   - [Phase 3: Company-Specific Investigation](#phase-3-company-specific-investigation)
   - [Phase 4: Individual Customer Issues](#phase-4-individual-customer-issues)
4. [Resolution Actions](#resolution-actions)
...
|----------|-------------|---------------|---------|
| **P1 (Critical)** | Multiple companies affected, widespread autopay failure | 15 minutes | System-wide revenue impact |
| **P2 (High)** | Single large company affected, >100 customers impacted | 30 minutes | Significant revenue impact |
| **P3 (Medium)** | Single small company affected, <100 customers impacted | 2 hours | Limited revenue impact |
...
| **Payment Gateway Support** | [Vendor] | [Phone] | [Email] |
